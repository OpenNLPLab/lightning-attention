...
speed_configs = [
    triton.testing.Benchmark(
        ...
        plot_name=f"lightning2-speed-{mode}-batch{b}-head{h}-dim{d}-dtype-{dtype_name}",
        args={
            "b": b,
            "h": h,
            "d": d,
...
memory_configs = [
    triton.testing.Benchmark(
        ...
        plot_name=f"lightning2-memory-{mode}-batch{b}-dim{d}-dtype-{dtype_name}",
        args={
            "b": b,
            "d": d,
            "dtype": dtype_map[dtype_name],
